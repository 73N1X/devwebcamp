<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripción Evento" rows="5"><?php echo $evento->descripcion ?></textarea>
    </div>
    <div class="formulario__campo">
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__leged">Información Extra</legend>
    <div class="formulario__campo">
